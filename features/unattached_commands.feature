Feature: Command behaviour when unattached
    ...
    Scenario Outline: services don't fail when an incompatible yaml package is installed
        ...
        And I run `pip3 install pyyaml==<yaml_version>` with sudo
        ...
        """
        Examples: ubuntu release
          | release | yaml_version | python_version |
          | xenial  | 6.0          | python3.5      |
          | bionic  | 6.0          | python3.6      |
          | focal   | 3.10         | python3.8      |
          | jammy   | 3.10         | python3.10     |
